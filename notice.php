...
<div class="">
  <div class="w3-row">
    ...
    <div class="w3-col m2 w3-container w3-padding">
      ...
      <a href="notice.php" style="text-decoration: none;" > <p class="rfont w3-small w3-bar w3-margin-top w3-text-black"><b>Notice >></b></p></a>
    ...
    <div class="w3-col m8 w3-container w3-padding">
      <div class="w3-border w3-padding-large">
        <p class="rfont"><b>RECENT NOTICE</b></p>
        <hr>
        <!--extract notice board start-->
        <?php
        	 $sqlNotice="SELECT * from newpost order by n desc";
        ...
        <div class="w3-border w3-padding">
          ...
          <?php
            ...
            if($image!=""||$image!=null){
          ?>
            <img src="uploads/posts/<?php echo $rowNotice['image']; ?>" width="100%">
          <?php } ?>
        </div>
        <hr>
        <?php
