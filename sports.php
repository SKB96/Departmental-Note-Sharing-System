...
<div class="">
  <div class="w3-row">
    ...
    <div class="w3-col m2 w3-container w3-padding">
      ...
      <a href="sports.php" style="text-decoration: none;" > <p class="rfont w3-small w3-bar w3-margin-top w3-text-black"><b>Sports >></b></p></a>
    ...
    <div class="w3-col m8 w3-container w3-padding">
      <div class="w3-border w3-padding-large">
        <p class="rfont"><b>RECENT SPORTS NEWS</b></p>
        <hr>
        <!--extract notice board start-->
        <?php
        	 $sqlNotice="SELECT * from newevent where type='sports' order by n desc";
