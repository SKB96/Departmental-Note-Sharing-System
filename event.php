...
<div class="">
  <div class="w3-row">
    ...
    <div class="w3-col m2 w3-container w3-padding">
      ...
      <a href="event.php" style="text-decoration: none;" > <p class="rfont w3-small w3-bar w3-margin-top w3-text-black"><b>Events >></b></p></a>
    ...
    <div class="w3-col m8 w3-container w3-padding">
      <div class="w3-border w3-padding-large">
        <p class="rfont"><b>RECENT EVENTS</b></p>
        <hr>
        <!--extract notice board start-->
        <?php
        	 $sqlNotice="SELECT * from newevent where type='event' order by n desc";
