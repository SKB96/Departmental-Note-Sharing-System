...
<div class="">
  <div class="w3-row">
    ...
    <div class="w3-col m2 w3-container w3-padding">
      ...
      <a href="alumna.php" style="text-decoration: none;" > <p class="rfont w3-small w3-bar w3-margin-top w3-text-black"><b>Alumni Information >></b></p></a>
    </div>
      ...
      <div class="w3-border w3-padding-large">
        ...
        <ul style="list-style-type: circle;">
          ...
          <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="post">
            ...
            <li><button class="w3-button w3-hover-white" name="albatch">CSE <?php echo $rowBatch['session']; ?> Batch</button></li>
          </form>
          <?php
            }
          ?>
