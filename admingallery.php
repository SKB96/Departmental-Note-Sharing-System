...
<div class="">
  <div class="w3-row">
    ...
    <div class="w3-col m2 w3-container w3-padding">
      ...
      <a href="admingallery.php" style="text-decoration: none;" > <p class="rfont w3-small w3-bar w3-margin-top  w3-text-black"><b>Upload gallery image >></b></p></a>
      ...
      <div class="w3-border w3-padding-large">
        <?php
          if(isset($_POST['newGallery'])){
            echo $_SESSION['msgGallery'];
            unset($_SESSION['msgGallery']);
          }
        ?>
        <p class="rfont"><b>UPLOAD GALLERY IMAGE</b></p>
        <hr>
        <div class="">
          <form  action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post" enctype="multipart/form-data">
            <div class="upload-btn-wrapper w3-margin-top">
              <button class="w3-btn w3-orange">Upload Image</button>
              <input type="file" accept="image/*" name="image" onchange="preview_image(event)"><br>
              <img id="output_image"/ style="width:200px;">
            </div>
            <br>
            <label>About image:</label>
            <textarea type="text" name="gtext" class="w3-input w3-border" rows="5"></textarea>
            <button class="w3-btn w3-blue w3-margin-top" name="newGallery">POST</button>
          </form>
...
<script>
  function hide(){
    document.getElementById('msgGallery').style.display="none";
  }
</script>
<!--page body end-->
