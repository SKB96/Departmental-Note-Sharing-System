...
<div class="">
  <div class="w3-row">
    ...
    <div class="w3-col m2 w3-container w3-padding">
      ...
      <a href="information.php" style="text-decoration: none;" > <p class="rfont w3-small w3-bar w3-margin-top w3-text-black"><b>Student Information >></b></p></a>
      <a href="teacherinfo.php" style="text-decoration: none;" > <p class="rfont w3-small w3-bar w3-margin-top w3-text-gray w3-hover-text-black"><b>Teacher Information</b></p></a>
    </div>
    <div class="w3-col m8 w3-container w3-padding">
      <div class="w3-border w3-padding-large">
        <p class="rfont"><b>STUDENT INFORMATION</b></p>
        <hr>
        <ul style="list-style-type: circle;">
          ...
          <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="post">
            ...
            <li><button class="w3-button w3-hover-white" name="batch">CSE <?php echo $rowBatch['session']; ?> Batch</button></li>
          </form>
          <?php
            }
          ?>
