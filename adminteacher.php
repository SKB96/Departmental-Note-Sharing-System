...
<div class="">
  <div class="w3-row">
    ...
    <div class="w3-col m2 w3-container w3-padding">
      ...
      <a href="adminteacher.php" style="text-decoration: none;" > <p class="rfont w3-small w3-bar w3-margin-top w3-text-black"><b>Add New Teacher >></b></p></a>
    </div>
    <div class="w3-col m8 w3-container w3-padding">
      <div class="w3-border w3-padding-large">
        <?php
          if(isset($_POST['add_new_teacher'])){
            echo $_SESSION['msgaddnewteacher'];
            unset($_SESSION['msgaddnewteacher']);
          }
        ?>
        <p class="rfont"><b>ADD NEW TEACHER</b></p>
        <hr>
        <div class="">
          <form  action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post" enctype="multipart/form-data">
            ...
            <input class="w3-input w3-margin-bottom" type="text" name="qualification" />
            <label>Designation</label>
            <input class="w3-input w3-margin-bottom" type="text" name="designation" />
            <label>Department</label>
            <input class="w3-input w3-margin-bottom" type="text" name="department" />
            <label>Contact</label>
            <input class="w3-input w3-margin-bottom" type="text" name="contact" />
            <label>Email</label>
            ...
            <button class="w3-btn w3-blue w3-right w3-margin-top" name="add_new_teacher">ADD</button>
